...
PALLET_TRUCK_CONTROL_PKG_PATH = os.path.expanduser(
    "simulation/pallet_truck/pallet_truck_control"
)
...
def generate_control_yaml(robots):
                ...
                namespace: {
                    ...
                    "velocity_controller": {
                        "ros__parameters": {
                            ...
                            "pose_covariance_diagonal": FlowStyleList(
                                [0.001, 0.001, 1000000.0, 1000000.0, 1000000.0, 0.03]
                            ),
                            "twist_covariance_diagonal": FlowStyleList(
                                [1000000.0, 1000000.0, 0.03, 1000000.0, 1000000.0, 0.03]
                            ),
                            "open_loop": False,
    ...
    yaml_comment = """\
###################################################################################################
# This control.yaml file was auto generated by config_generation/scripts/generate_control_yaml.py #
###################################################################################################"""
