...
from humanoid_camera_system.srv import CaptureMotionStatus
...
class PoseDetector(Node):
    def __init__(self):
        ...
        self.declare_parameter("camera_ids", "500 501 502 503")
        self.camera_ids = (
            self.get_parameter("camera_ids").get_parameter_value().string_value.split()
        )
