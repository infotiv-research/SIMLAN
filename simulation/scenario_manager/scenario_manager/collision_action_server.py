...
class CollisionActionServer(Node):
    ...
    async def execute_callback(self, goal_handle):
        ...
        await self.set_robot_speed(self.jackal_name, self.jackal_speed, 0.0, 0.0, self.drive_time_multiplier * self.experiment_time)
        await self.set_robot_speed(self.pallet_truck_name, pallet_truck_speed, 0.0, 0.0, self.drive_time_multiplier * self.experiment_time)
