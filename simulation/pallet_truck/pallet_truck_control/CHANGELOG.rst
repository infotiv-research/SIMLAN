^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package pallet_truck_control
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
1.0.1 (2022-10-14)
------------------
* [pallet_truck_control] Fixed wrong dependency.
...
* Add the pallet_truck_JOY_DEVICE envar to optionally override the joy device more easily.
...
0.7.2 (2020-09-29)
------------------
* Load the control extras last (`#75 <https://github.com/pallet_truck/pallet_truck/issues/75>`_)
* Remove the PS4 device from the yaml file, always apply the parameter from the joy_dev argument instead (`#73 <https://github.com/pallet_truck/pallet_truck/issues/73>`_)
* Contributors: Chris I-B

0.7.1 (2020-08-24)
------------------
* Disable ekf option (`#71 <https://github.com/pallet_truck/pallet_truck/issues/71>`_)
...
* [pallet_truck_control] Added control extras.
...
0.6.0 (2018-04-12)
------------------
* [pallet_truck_control] Made the PS4 controller default.
...
* Increased inflation radius to account for uneven wall in pallet_truck_world.
...
* New pallet_truck_control package.
  This is launchers and configuration common to simulated and real
  pallet_truck, including controller, localization, and teleop.
* Contributors: Mike Purvis
