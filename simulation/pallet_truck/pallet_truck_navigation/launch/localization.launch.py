...
def generate_launch_description():
    ...
    pkg_pallet_truck_navigation = FindPackageShare("pallet_truck_navigation")
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        ...
        default_value=PathJoinSubstitution(
            [pkg_pallet_truck_navigation, "maps", "office.yaml"]
        ),
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        "params_file",
        default_value=PathJoinSubstitution(
            [pkg_pallet_truck_navigation, "config", "nav2.yaml"]
        ),
